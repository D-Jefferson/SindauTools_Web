...
const Home2: React.FC = () => {
  const formatador1 = () =>
    navigate("/demo/ferramentas", { state: { abaInicial: "notificacao" } });

  const formatador2 = () =>
    navigate("/demo/ferramentas", { state: { abaInicial: "vincular" } });

  const formatador3 = () =>
    navigate("/demo/ferramentas", { state: { abaInicial: "desvincular" } });

  const formatador4 = () =>
    navigate("/demo/ferramentas", { state: { abaInicial: "matricula" } });
    ...
    <div className="page-container">
      ...
      <aside className="menu-lateral-inicio" id="menu-lateral-inicio">
        ...
        <nav className="lateral-nav">
          <a onClick={() => navigate("/demo/home")} className="active">
